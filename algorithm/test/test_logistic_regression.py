...
import arno_logistic_regression
...
if __name__ == "__main__":
    ...
    #arno_logistic_regression.train_test(X_train,X_test,y_train,y_test)
    arno_logistic_regression.train_test1(X_train,X_test,y_train,y_test)
